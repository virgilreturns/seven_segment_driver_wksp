...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, REGISTER_LATCH_Pin|GPIO_PIN_4|GPIO_PIN_6|DIGIT_2_SEL_Pin
  ...
  /*Configure GPIO pins : REGISTER_LATCH_Pin DIGIT_2_SEL_Pin DIGIT_4_SEL_Pin */
  GPIO_InitStruct.Pin = REGISTER_LATCH_Pin|DIGIT_2_SEL_Pin|DIGIT_4_SEL_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
